...
tests = [
    ...
    {'description': 'Check single increment',
    ...
    {'description': 'Check single decrement',
        'steps': [ {'inputs': [('PINA',0x00)], 'iterations': 2 } ],
        'expected': [('PORTC', 0x00)],
        'steps': [ {'inputs': [('PINA',0x02)], 'iterations': 3 } ],
        'expected': [('PORTC', 0x07)],
    },
    {'description': 'I want to go back to gdb, thss type of testing is annoying',
        'steps': [ {'inputs': [('PINA',0x00)], 'iterations': 2 } ],
        'expected': [('PORTC', 0x00)],
        'steps': [ {'inputs': [('PINA',0x01)], 'iterations': 3 } ],
        'expected': [('PORTC', 0x08)],
...
watch = ['counter::tmpC', 'main::state', 'PINA', 'PORTC']
